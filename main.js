...
//1000
    ...
    },
    {
        ...
        colors:"#416179",
      image: "karte.jpg",
        text: "Du merkst, dass du hungrig und durstig wirst. Deine Vorräte sind begrenzt und du wirst gezwungen, das Schiff nach Lebensmitteln zu durchsuchen. Zum Glück liegt bei einer Tür eine Karte des Schiffs. Du nimmst sie um zurecht zu finden. Du darfst nicht vergessen, leise und vorsichtig vorzugehen, um nicht entdeckt zu werden…",
        options: [
            {
                text: "Weiter.",
                setState: { },
...
},
{
    ...
    colors: "#120e0e",
    loop: "kuecherot.mp4",
    text: "Mehr oder weniger geschickt schlüpfst du durch die nächste Tür und findest dich in der Schiffsküche wieder. Du siehst dich wieder um. Alles hier drinnen ist verwüstet. Du zuckst auf. Es sind Schritte von draußen zu hören und sie werden lauter.",
    countdown: {
        time: 20,
        targetNode: "go06",
    },
